...
db.usuarios.insertMany([
  { _id: usuarioAdminId, email: "admin@ticketflow.pe", password_hash: "$2b$10$EjemploHashSoloDemoNoUsarEnProduccion", username: "admin_ticketflow", nombre_completo: "Administrador TicketFlow", foto_perfil_url: "https://ticketflow.sfo3.digitaloceanspaces.com/perfiles/admin.webp", fecha_registro: hace30dias, rol: "admin" },
  { _id: usuarioOrg1Id, email: "victor.arapa@upc.edu.pe", password_hash: "$2b$10$EjemploHashSoloDemoNoUsarEnProduccion", username: "victor_arapa", nombre_completo: "Victor Piero Arapa Titi", foto_perfil_url: "https://ticketflow.sfo3.digitaloceanspaces.com/perfiles/victor.webp", fecha_registro: hace30dias, rol: "organizador" },
  { _id: usuarioOrg2Id, email: "cesar.quispe@upc.edu.pe", password_hash: "$2b$10$EjemploHashSoloDemoNoUsarEnProduccion", username: "cesar_quispe", nombre_completo: "Cesar Augusto Quispe Llacsahuanga", foto_perfil_url: "https://ticketflow.sfo3.digitaloceanspaces.com/perfiles/cesar.webp", fecha_registro: hace30dias, rol: "organizador" },
  { _id: usuario1Id, email: "rai.manrique@upc.edu.pe", password_hash: "$2b$10$EjemploHashSoloDemoNoUsarEnProduccion", username: "rai_manrique", nombre_completo: "Rai Jeferson Manrique Anaya", foto_perfil_url: "https://ticketflow.sfo3.digitaloceanspaces.com/perfiles/rai.webp", fecha_registro: hace7dias, rol: "usuario" },
  { _id: usuario2Id, email: "maria.lopez@gmail.com", password_hash: "$2b$10$EjemploHashSoloDemoNoUsarEnProduccion", username: "maria_eventos", nombre_completo: "Maria Lopez Fernandez", foto_perfil_url: "https://ticketflow.sfo3.digitaloceanspaces.com/perfiles/maria.webp", fecha_registro: hace7dias, rol: "usuario" },
  { _id: usuario3Id, email: "carlos.ramirez@gmail.com", password_hash: "$2b$10$EjemploHashSoloDemoNoUsarEnProduccion", username: "carlos_ramirez", nombre_completo: "Carlos Ramirez Vega", fecha_registro: hace7dias, rol: "usuario" },
  { _id: usuario4Id, email: "ana.torres@gmail.com", password_hash: "$2b$10$EjemploHashSoloDemoNoUsarEnProduccion", username: "ana_torres", nombre_completo: "Ana Torres Mendoza", fecha_registro: hace7dias, rol: "usuario" }
]);

db.eventos.insertMany([
  { _id: eventoConciertoId, creador_id: usuarioOrg1Id, titulo: "Megaconcierto BTS en Lima 2026", descripcion: "Tres fechas en el Estadio Nacional. Venta oficial sin reventa.", categoria: "concierto", ciudad: "Lima", fecha_evento: ISODate("2026-08-15T20:00:00Z"), flyer_url: "https://ticketflow.sfo3.digitaloceanspaces.com/eventos/bts-lima-2026.webp", ubicacion: { type: "Point", coordinates: [-77.0353, -12.0919] }, asistentes: [usuario1Id, usuario2Id, usuario3Id], estado: "publicado" },
  { _id: eventoFestivalId, creador_id: usuarioOrg2Id, titulo: "Festival Selva Sonora 2026", descripcion: "Festival de musica peruana e internacional en el Jockey Club.", categoria: "festival", ciudad: "Lima", fecha_evento: ISODate("2026-09-20T18:00:00Z"), flyer_url: "https://ticketflow.sfo3.digitaloceanspaces.com/eventos/selva-sonora.webp", ubicacion: { type: "Point", coordinates: [-77.0253, -12.1247] }, asistentes: [usuario2Id, usuario4Id], estado: "publicado" },
  { _id: eventoTeatroId, creador_id: usuarioOrg1Id, titulo: "Hamlet - Teatro Municipal de Lima", descripcion: "Obra clasica con elenco nacional.", categoria: "teatro", ciudad: "Lima", fecha_evento: ISODate("2026-07-10T19:30:00Z"), flyer_url: "https://ticketflow.sfo3.digitaloceanspaces.com/eventos/hamlet-teatro.webp", ubicacion: { type: "Point", coordinates: [-77.0300, -12.0464] }, asistentes: [usuario1Id], estado: "publicado" }
]);
...
db.publicaciones.insertMany([
  { _id: publicacion1Id, usuario_id: usuario1Id, evento_id: eventoConciertoId, texto: "Ya tengo mi entrada VIP para BTS! Alguien del grupo UPC va en la misma fila?", media_urls: ["https://ticketflow.sfo3.digitaloceanspaces.com/posts/bts-entrada.webp"], fecha_publicacion: hace7dias, usuarios_likes: [usuario2Id, usuario3Id, usuario4Id] },
  { _id: publicacion2Id, usuario_id: usuario2Id, evento_id: eventoFestivalId, texto: "Selva Sonora va a estar increible. Busco grupo para ir juntos desde San Miguel.", fecha_publicacion: hace7dias, usuarios_likes: [usuario1Id] },
